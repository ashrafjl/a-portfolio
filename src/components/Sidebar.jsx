...
const Sidebar = () => {
  ...
  return (
    <div className={`sm:w-1/3 w-full h-fit rounded-[16px] shadow-mini sm:sticky top-[70px] p-4 ${context?.isDark ? 'bg-[#000000]' : 'bg-[white]'}`}>
        <div className={`rounded-[16px] overflow-hidden flex items-center justify-center ${context?.isDark ? 'bg-dark-bg' : 'bg-light-bg'}`}>
            <img src={Me} alt="" className='object-cover object-center max-w-[300px] max-h-[300px] w-full'/>
        </div>
        <div className='mt-[10px]'>
          ...
          <div className='flex items-center flex-wrap gap-2 mt-[10px]'>
            <button className='bg-transparent w-full border border-[#576076] text-[#576076] h-[50px] leading-[50px] rounded-[8px] px-[10px] min-w-[150px] flex items-center justify-center gap-2'><span><MdContentCopy /></span> Copy Email</button>
            <button className='bg-transparent w-full border border-[#576076] text-[#576076] h-[50px] leading-[50px] rounded-[8px] px-[10px] min-w-[150px] flex items-center justify-center gap-2'><span><FaWhatsapp /></span>WhatsApp</button>
